    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(199, 110, 185,1)50%, rgba(143, 70, 148, 1))",
          color: "#fbbf24",
          WebkitTextStroke: "0.17vw #241555ff",
          lineHeight: "1",
          cursor: "pointer",
      ...
      <div
        ...
        style={{
          ...
          zIndex: 100000,
          background:
            "radial-gradient(circle,rgba(169, 87, 175, 0.8)50%,rgba(133, 58, 138,1))",
          borderRadius: "20px",
          padding: "24px", 
          minWidth: "20vw",
          maxWidth: "35vw",
        ...
        {currentStep.title && (
          <h3
            style={{
              ...
              fontSize: "3vw",
              color: "#fbbf24",
              WebkitTextStroke: "0.24vw #241555ff",
              lineHeight: 1.2,
            }}
          >
            {currentStep.title}
          ...
          {currentStepIndex > 0 && (
            <button
              ...
              style={{
                ...
                border: "0.25vw solid #fbbf24",
                background:
                  "radial-gradient(circle, rgba(113, 49, 151, 1)50%,  rgba(82, 30, 112, 1))",
                color: "#fbbf24",
                lineHeight: "1",
              }}
              onMouseEnter={(e) => {
