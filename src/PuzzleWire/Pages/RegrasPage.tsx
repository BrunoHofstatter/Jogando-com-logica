  ...
  return (
    <div className={styles.regrasPage}>
      <div className={styles.boxRegras}>
        <div className={styles.gameTitle}>Puzzle Wire</div>
        <img
          src={`${import.meta.env.BASE_URL}stopPreview.png`}
          className={styles.preview}
          alt="Prévia do Puzzle Wire"
        />
      </div>
      ...
      <div className={styles.botoes}>
        <button
          ...
          onClick={() => navigate(ROUTES.PUZZLE_WIRE_GAME)}
        >
          <span>Jogar</span>
        </button>
        ...
        <div className={styles["mode-select-rules"]}>
          <div className={styles.levelsRow}>
            <label>
              <input type="radio" name="puzzlewire-mode" checked readOnly />
              Níveis
            </label>
            <button
              className={styles.levelsButton}
              onClick={() => navigate(ROUTES.PUZZLE_WIRE_LEVELS)}
            >
              Abrir
            </button>
          </div>
            ...
            >
              ...
              <div className={styles.detailedRules}>
                ...
                <p>
                  ...
                  os componentes específicos do Puzzle Wire.
                </p>
              </div>
            </div>
          </div>
