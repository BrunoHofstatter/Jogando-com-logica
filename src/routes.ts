export const ROUTES = {
    ...
    // Damas (Checkers)
    DAMAS_RULES: "/damas/regras",
    DAMAS_GAME: "/damas/jogo",
    DAMAS_RULES_BASE: "/damas/regras-base",

    // Stop (Categories Game)
    ...
    // Crown Chase
    CROWN_CHASE_RULES: "/coroa-maluca/regras",
    CROWN_CHASE_GAME: "/coroa-maluca",
    CROWN_CHASE_AI: "/coroa-maluca/computador",

    // Math War
    MATH_WAR_RULES: "/batalha-matematica/regras",
    MATH_WAR_GAME: "/batalha-matematica",
    MATH_WAR_AI: "/batalha-matematica/computador",
