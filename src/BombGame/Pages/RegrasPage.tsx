  ...
  return (
    <div className={styles.regrasPage}>
      <div className={styles.boxRegras}>
        <div className={styles.gameTitle}>Bomb Game</div>
        <img
          src={`${import.meta.env.BASE_URL}stopPreview.png`}
          className={styles.preview}
          alt="Prévia do Bomb Game"
        />
      </div>
      ...
      <div className={styles.botoes}>
        <button
          ...
          onClick={() => navigate(ROUTES.BOMB_GAME_GAME)}
        >
          <span>Jogar</span>
        </button>
        ...
        <div className={styles["mode-select-rules"]}>
          <div className={styles.levelsRow}>
            <label>
              <input type="radio" name="bombgame-mode" checked readOnly />
              Níveis
            </label>
            <button
              className={styles.levelsButton}
              onClick={() => navigate(ROUTES.BOMB_GAME_LEVELS)}
            >
              Abrir
            </button>
          </div>
            ...
            >
              ...
              <div className={styles.detailedRules}>
                ...
                <p>
                  ...
                  os componentes específicos do Bomb Game.
                </p>
              </div>
            </div>
          </div>
