    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          fontSize: "2.5vw",
          borderRadius: "1.5vw",
          border: "0.25vw solid #0bdd63ff",
          background:
            "radial-gradient(circle, #7da787ff 50%, #64856bff)",
          color: "#f3f4f6",
          WebkitTextStroke: "0.17vw #54595eff",
          lineHeight: "1",
          cursor: "pointer",
      ...
      {currentStep.highlight && spotlightRect && (
        <div
          style={{
            ...
            border: "4px solid #0bdd63ff",
            borderRadius: "16px",
            boxShadow: "0 0 0 99999px rgba(0, 0, 0, 1), 0 0 30px #0bdd63ff",
            zIndex: 99999,
            pointerEvents: "none",
        ...
        {currentStep.title && (
          <h3
            style={{
              ...
              fontSize: "3vw",
              color: "#f3f4f6",
              WebkitTextStroke: "0.24vw #54595eff",
              lineHeight: 1.2,
            }}
          >
            {currentStep.title}
          ...
          {currentStepIndex > 0 && (
            <button
              ...
              style={{
                ...
                border: "0.25vw solid #0bdd63ff",
                background:
                  "radial-gradient(circle, rgba(121, 119, 122, 1)50%,  rgba(92, 92, 95, 1))",
                color: "#0bdd63ff",
                lineHeight: "1",
              }}
              onMouseEnter={(e) => {
      ...
      <style>{`
        @keyframes tutorialPulse {
          0%, 100% {
            box-shadow: 0 0 0 99999px rgba(0, 0, 0, 0.4), 0 0 30px #0bdd63ff;
          }
          50% {
            box-shadow: 0 0 0 99999px rgba(0, 0, 0, 0.4), 0 0 30px #0bdd63ff;
          }
