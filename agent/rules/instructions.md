...
- **Mobile First**: All UI MUST be designed for mobile/tablet first (< 768px). 
- **Touch Friendly**: Ensure interactive elements are large enough for touch inputs. Avoid hover-dependent functionality.
